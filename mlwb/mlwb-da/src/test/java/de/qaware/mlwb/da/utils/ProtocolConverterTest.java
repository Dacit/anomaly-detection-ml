 ...
 */
public class ProtocolConverterTest extends AbstractProtocolConverterTest {
    DateValuePairMapperBuffer mapper;
...
//    }
    ...
    public void testAsPointsWithIllegalArgument() throws Exception {
        DateValuePairMapperBuffer.uncompressAndDecode(null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testAsZippedAndBase64EncodedWithIllegalInput() throws Exception {
        mapper.compressAndEncodeData(null);
